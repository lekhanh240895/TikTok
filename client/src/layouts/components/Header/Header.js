          ...
          {currentUser ? (
            <>
              ...
              >
                ...
                >
                  {location.pathname === "/messages" ? (
                    <SolidMessageIcon width="2.6rem" height="2.6rem" />
                  ) : (
                    <MessageIcon width="2.6rem" height="2.6rem" />
                  )}
                  <span className={cx("badge", "icon-wrapper")}>
              ...
              <div className="icon-wrapper">
                <HeadlessTippy
                  ...
                  render={(attrs) => (
                    <div
                      className={cx("notifications-wrapper")}
                      tabIndex="-1"
                      {...attrs}
                    >
                      <PopperWrapper style={{ overflow: "unset" }}>
                        <Notifications notifications={orderedNotifications} />
                      </PopperWrapper>
            ...
            <>
              <Button
                ...
                onClick={() => dispatch(loginModalSlice.actions.show())}
              >
                Log in
              </Button>
            </>
