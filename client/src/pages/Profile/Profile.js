  ...
  return (
    <Container className="profile">
      <div className="header">
        <div className="share-info">
          ...
          <div className="share-title">
            <h2>
              {user.username}
              {user.tick && <CheckedIcon width="2rem" height="2rem" />}
            </h2>
            ...
            {isUser && (
              <Button
                ...
                onClick={() => dispatch(editModalSlice.actions.show())}
              >
                Edit profile
              </Button>
            )}
            ...
            {!isUser &&
              (!isFollowed ? (
                ...
                <div className="button-group">
                  ...
                  <Tippy placement="bottom" content="Unfollow">
                    <span
                      className="friend-icon icon-wrapper"
                      onClick={handleUnFollow}
                    >
                      <IsFriendIcon width="2rem" height="2rem" />
                    </span>
                  </Tippy>
                </div>
              ))}
      ...
      <ul className="nav-list">
        <li
          className={activeTab === "videos" ? "nav-item active" : "nav-item"}
        ...
        <li
          className={activeTab === "liked" ? "nav-item active" : "nav-item"}
            ...
            <ShareVideoItem video={video}>
              <div className="sub-content">
                <span className="icon-wrapper">
                  <RegularPlayIcon width="1.8rem" height="1.8rem" />
                </span>
                <span className="video-info">{configNumber(video.views)}</span>
              </div>
            </ShareVideoItem>
          </div>
        ))}
