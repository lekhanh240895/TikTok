...
export default function VideoPreview({
    ...
    const [changeVideoModalShow, setChangeVideoModalShow] = useState(false);
    ...
    return (
        <Wrapper>
            ...
            {changeVideoModalShow && (
                <ChangeVideoModal
                    onChangeVideo={onChangeVideo}
                    onCancel={() => setChangeVideoModalShow(false)}
                />
            )}
        </Wrapper>
    );
